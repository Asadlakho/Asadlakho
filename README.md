...
🌍 Actively targeting **global remote jobs** (U.S. Eastern & Western Europe).  

---

## 🔹 About Me
- 💻 Full-Stack MERN Developer (React.js, Next.js, Node.js, Express.js, MongoDB)  
- 🎨 UI/UX Design Principles with Tailwind CSS for modern SaaS look  
- 🔐 JWT Authentication, REST APIs, GraphQL, Performance Optimization  
